...
data_directory = Path(r"C:\Users\jla23480\Downloads\Data")  # Folder for which to create the tree
data_directory_contents = data_directory.glob("**/*")  # Contents of directory of interest
...
with open('file_tree.csv', 'w', encoding='utf-8') as f:
    for filepath in files:
        ...
        for n in range(shared_path_length, len(filepath.parts)):
            ...
            f.write(f"{separator}{separator*n}{filepath.parts[n]}{separator*(length_longest_filepath-n-1)}\n")
